...
var sharedSecret = "shubham_test";
var issuer = "shubham_test";

/* Here we setup the security checks for the endpoints that need it (in our case, only /protected). This function will be called every time a request to a protected endpoint is received. */
  ...
  if (token && token.indexOf("Bearer ") == 0) {
    ...
    jwt.verify(tokenString, sharedSecret, function(
      ...
      if (
        ...
        // you can add more verification checks for the token here if necessary, such as checking if the username belongs to an active user
